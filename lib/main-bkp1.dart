...
void main() async {
  ...
  // Initialize the AuthService and HC20Service
...
List<Map<String, dynamic>> _convertSleepRowsToJson(List<dynamic> sleepRows) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      drawer: const SideDrawer(currentRoute: '/hc20'),
      appBar: AppTopBar(
        onLogoTap: () {
          // Open drawer when logo is tapped
          _scaffoldKey.currentState?.openDrawer();
        },
        onDeviceIconTap: () {
          // Device icon tap - could show device details or navigate
          if (_connectedDevice != null) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text('Connected to: ${_connectedDevice!.name}'),
