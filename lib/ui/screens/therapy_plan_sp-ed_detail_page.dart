...
class TherapyPlanSpEdDetailPage extends StatefulWidget {
  final Map<String, dynamic> report;
  const TherapyPlanSpEdDetailPage({Key? key, required this.report}) : super(key: key);

  @override
  State<TherapyPlanSpEdDetailPage> createState() => _TherapyPlanSpEdDetailPageState();
}

class _TherapyPlanSpEdDetailPageState extends State<TherapyPlanSpEdDetailPage> {
  ...
  Map<String, dynamic> _staticData() => {
    ...
    'gender': 'N/A',
    'dob': 'N/A',
    'diagnosis': _r['description']?.toString() ?? 'Specific Learning Disability',
    'therapistName': 'Special Educator',
    'joiningDate': 'N/A',
    ...
    'goals': [
      {
        ...
        'subDomains': [
          {
            'subDomain': 'Reading Fluency',
            'observation': 'Child reads at a significantly below grade-level pace with frequent omissions and substitutions of words.',
            'shortTerm': 'Read a 50-word passage at grade level with 80% accuracy using phonics-based decoding strategies.',
            'longTerm': 'Read grade-appropriate texts fluently and independently with 90% accuracy.',
            'relevance': 'Reading fluency is foundational for academic success across all subjects.',
          },
          {
            'subDomain': 'Phonological Awareness',
            'observation': 'Child struggles to identify rhyming words and segment syllables in spoken words.',
            'shortTerm': 'Correctly identify and produce rhyming word pairs in 4/5 trials during structured activities.',
            'longTerm': 'Demonstrate age-appropriate phonological awareness skills including blending and segmenting.',
            'relevance': 'Phonological awareness is a critical precursor to decoding and spelling skills.',
          },
        ],
      },
      {
        ...
        'subDomain': 'Number Concepts & Operations',
        'observation': 'Child has difficulty understanding place value and performing two-digit addition with regrouping.',
        'shortTerm': 'Correctly solve 10 two-digit addition problems with regrouping using manipulatives in 3/5 sessions.',
        'longTerm': 'Independently solve two and three-digit addition and subtraction problems with 85% accuracy.',
        'relevance': 'Numeracy skills are essential for daily life functioning and academic progression.',
      },
      {
        'number': 3,
        'title': 'Attention & Executive Function',
        'subDomain': 'Task Persistence & Organization',
        'observation': 'Child frequently goes off-task within 5 minutes and has difficulty organizing multi-step assignments.',
        'shortTerm': 'Remain on-task for 15 minutes during structured academic activities with visual timer support.',
        'longTerm': 'Independently organize and complete multi-step academic tasks using a self-monitoring checklist.',
        'relevance': 'Attention and organization skills directly impact academic performance and classroom participation.',
      },
    ],
    'approaches': [
      {'title': 'Individualized Education Program (IEP)', 'description': 'Customized learning plan addressing the unique educational needs and goals of the child with measurable objectives.'},
      {'title': 'Multi-Sensory Learning', 'description': 'Engaging visual, auditory, and kinesthetic modalities to enhance learning retention and concept understanding.'},
      {'title': 'Differentiated Instruction', 'description': 'Adapting teaching methods and materials to accommodate different learning styles, paces, and abilities.'},
      {'title': 'Assistive Technology Integration', 'description': 'Using tools such as text-to-speech, graphic organizers, and digital aids to support learning and overcome barriers.'},
      {'title': 'Positive Reinforcement & Behavior Support', 'description': 'Encouraging desired academic behaviors and engagement through systematic reinforcement strategies.'},
      {'title': 'Parent & Teacher Collaboration', 'description': 'Working together to ensure consistent support and implementation of educational strategies across home and school.'},
    ],
    'notes': 'Consistent implementation of individualized strategies and positive reinforcement will enhance learning progress and support the child\'s educational and developmental goals.\n\nRegular communication between special educator and family ensures alignment on goals and strategies. Progress will be monitored through assessments and the education plan adjusted as needed based on the child\'s response and skill acquisition trajectory.',
  };
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Special Education Therapy Plan',
        ...
        child: Stack(children: [
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Special Education Therapy Plan',
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Row(children: [
          ...
          SizedBox(width: 10),
          Text('Special Education Approaches and Strategies',
