  ...
  Widget _buildBanner() {
    return Builder(
      builder: (context) {
        ...
        // Specific negative offsets for different screen sizes
        double offsetY = -10; // Default for web/desktop
        ...
        return Transform.translate(
          ...
          child: ClipRRect(
            ...
            child: Container(
              padding: const EdgeInsets.only(top: 80), // Push content below header
              child: Image.asset(
